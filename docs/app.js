  ...
  return {
    view: function view(_ref) {
      ...
      return (0, _mithril2.default)("aside.navbar", (0, _mithril2.default)(_button2.default, {
        ...
        action: function action() {
          mdl.preventUpdate(false);
          mdl.orientation == "portrait" ? mdl.orientation = "landscape" : mdl.orientation = "portrait";
        },
...
var PrintTools = function PrintTools() {
  return {
    view: function view(_ref2) {
...
var Toolbar = function Toolbar() {
  return {
    view: function view(_ref3) {
      ...
      return _mithril2.default.route.get() == "/easel" ? (0, _mithril2.default)(EaselTools, { mdl: mdl }) : (0, _mithril2.default)(PrintTools, { mdl: mdl });
    }
  };
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _mithril2.default.route(root, "/print", routes(_model2.default));
});
});
