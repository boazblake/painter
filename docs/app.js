...
var Toolbar = function Toolbar() {
  return {
    view: function view(_ref2) {
      ...
      return _mithril2.default.route.get() == "/easel" && (0, _mithril2.default)(EaselTools, { mdl: mdl });
    }
  };
};
...
var GalleryTools = function GalleryTools() {
  return {
    view: function view(_ref) {
      ...
      return (0, _mithril2.default)("aside.navbar.toolbar", mdl.canvas() !== null && [(0, _mithril2.default)(_button2.default, {
        mdl: mdl,
        classList: "toolBtn",
...
var Modal = function Modal(_ref2) {
  ...
  return {
    view: function view(_ref3) {
      ...
      }, (0, _mithril2.default)(".modal", [children, (0, _mithril2.default)(GalleryTools, { mdl: mdl })]));
    }
  };
};

var resetModal = function resetModal(_ref4) {
...
var Gallery = function Gallery() {
  return {
    ...
    view: function view(_ref5) {
      ...
      return [(0, _mithril2.default)(".gallery", mdl.artworks().map(function (_ref6) {
        var art = _ref6.art;
